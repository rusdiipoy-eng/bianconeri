...
p.nominalBounds = new cjs.Rectangle(0,0,480,1800);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-480,-242,0.5,0.5);

	this.instance_1 = new lib.bg2();
	this.instance_1.setTransform(-321,-240,0.5,0.5);
...
p.nominalBounds = new cjs.Rectangle(-480,-242,319,602);
...
if (reversed == null) { reversed = false; }
	...
	this.instance_2.setTransform(163.95,571.6,0.8052,0.8052,0,0,0,0.1,0.1);
	this.instance_2._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_2).wait(133).to({_off:false},0).to({x:135.25,y:509.25},14).to({startPosition:0},11).to({scaleX:0.6025,scaleY:0.6025,x:126.75,y:503.25},10).to({scaleX:0.8052,scaleY:0.8052,x:135.25,y:509.25},10).to({startPosition:0},26).to({scaleX:0.6025,scaleY:0.6025,x:126.75,y:503.25},11).to({scaleX:0.8052,scaleY:0.8052,x:135.25,y:509.25},11).wait(1));

	// Layer_12
	this.instance_3 = new lib.Tween18("synched",0);
	this.instance_3.setTransform(79.55,490.85,0.043,0.043);
	this.instance_3._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_3).wait(120).to({_off:false},0).to({regX:0.1,scaleX:1.0098,scaleY:1.0098,x:79.65},13).to({regX:0,scaleX:0.8642,scaleY:0.8642,x:79.55},14).to({startPosition:0},11).to({regX:0.1,scaleX:0.7116,scaleY:0.7116,x:79.6},10).to({regX:0,scaleX:0.8642,scaleY:0.8642,x:79.55},10).to({startPosition:0},26).to({regX:0.1,scaleX:0.7116,scaleY:0.7116,x:79.6},11).to({regX:0,scaleX:0.8642,scaleY:0.8642,x:79.55},11).wait(1));
	...
	this.instance_5.setTransform(15.55,262.55);
	...
	this.instance_6.setTransform(259.55,334.55);
	this.instance_6._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_6).wait(37).to({_off:false},0).to({x:113.15,y:334.6},21,cjs.Ease.quintIn).to({rotation:3.9662},20,cjs.Ease.none).to({rotation:0},22,cjs.Ease.none).wait(127));

	// royal
	this.instance_7 = new lib.Tween13("synched",0);
	this.instance_7.setTransform(199.65,346.3);
	this.instance_7._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_7).wait(37).to({_off:false},0).to({x:53.25,y:346.35},21,cjs.Ease.quintIn).to({rotation:9.9812,x:53.2},15,cjs.Ease.none).to({rotation:1.3194,y:346.4},22,cjs.Ease.none).wait(132));

	// Layer_15
	this.instance_8 = new lib.Symbol4();
	this.instance_8.setTransform(78.95,323.6,0.4778,0.4778,0,0,0,78.9,307.6);
	this.instance_8.compositeOperation = "screen";
	this.instance_8._off = true;

	this.timeline.addTween(cjs.Tween.get(this.instance_8).wait(116).to({_off:false},0).to({regY:307.5,scaleX:1,scaleY:1,x:78.9,y:307.5},32).wait(79));

	// pop
	this.instance_9 = new lib.pop();
	this.instance_9.setTransform(2.6,173.45,0.5083,0.5083,0,0,0,0.1,0.3);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance_10).to({scaleX:1,scaleY:1,x:480},37,cjs.Ease.quintIn).to({x:319.35},21,cjs.Ease.quintIn).wait(1).to({regX:-320.5,regY:59,x:-1.15,y:299},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-1.1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-1.05},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-1},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.95},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.9},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.85},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.8},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.75},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.7},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.65},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.6},0).wait(1).to({startPosition:0},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.55},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.5},0).wait(1).to({x:-0.45},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.4},0).wait(1).to({x:-0.35},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.3},0).wait(1).to({x:-0.25},0).wait(1).to({x:-0.2},0).wait(1).to({x:-0.15},0).wait(1).to({startPosition:0},0).wait(1).to({x:-0.1},0).wait(1).to({x:-0.05},0).wait(1).to({x:0.05},0).wait(1).to({x:0.1},0).wait(1).to({x:0.15},0).wait(1).to({x:0.2},0).wait(1).to({x:0.25},0).wait(1).to({x:0.35},0).wait(1).to({x:0.4},0).wait(1).to({x:0.5},0).wait(1).to({x:0.55},0).wait(1).to({x:0.65},0).wait(1).to({x:0.75},0).wait(1).to({x:0.85},0).wait(1).to({x:0.95},0).wait(1).to({x:1},0).wait(1).to({x:1.1},0).wait(1).to({x:1.2},0).wait(1).to({regX:0,regY:0,x:321.85,y:240},0).wait(33));
...
p.nominalBounds = new cjs.Rectangle(-80.6,285.7,404.4,336.8);
// library properties:
lib.properties = {
